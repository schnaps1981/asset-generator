...
function generate(files, targetAndroid, targetIos) {
    for (let file of files) {
        ...
        if (typeof targetAndroid !== "undefined") {
            resizeAndSave(0.25, file, targetAndroid + 'drawable-mdpi/' + filename + filetype);
            resizeAndSave(0.375, file, targetAndroid + 'drawable-hdpi/' + filename + filetype);
            resizeAndSave(0.5, file, targetAndroid + 'drawable-xhdpi/' + filename + filetype);
            resizeAndSave(0.75, file, targetAndroid + 'drawable-xxhdpi/' + filename + filetype);
            resizeAndSave(1, file, targetAndroid + 'drawable-xxxhdpi/' + filename + filetype);
        }
